...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE manager SET ManagerNo = '$ManagerNo', IC = '$IC', manager = '$manager', company = '$company', department = '$department', 
    position = '$position', email = '$email', category = '$category', status = '$status', modifiedBy = '" . $_SESSION['Alogin'] . "', modifiedDate = '" . $timestamp . "'
    WHERE id = '$id'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('Manager details is edited successfully.');</script>";
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="manager" type="textfield" value="<?php echo $row["manager"]?>" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="ManagerNo" type="textfield" value="<?php echo $row["ManagerNo"]?>" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="IC" type="textfield" value="<?php echo $row["IC"]?>" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="email" type="textfield" value="<?php echo $row["email"]?>" class="form-control" required>
                        </div>
                    </div>
