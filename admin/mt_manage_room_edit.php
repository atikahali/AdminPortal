...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tblroom SET description = '$description', status = '$status', modifiedBy = '".$_SESSION['Alogin']."', modifiedDate = '" . $timestamp . "' WHERE roomId = '$roomId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('The room is edited successfully.');</script>";
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="description" type="textfield" value="<?php echo $row["description"]?>" class="form-control" required>
                        </div>
                    </div>
