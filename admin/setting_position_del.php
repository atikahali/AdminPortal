...
if (isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM position WHERE pstId = '$pstId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('Position details is deleted successful.');</script>";
...
?>
<h2 class="page-title">Delete Position</h2>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="position" type="textfield" value="<?php echo $row["position"]?>" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="pstStatus" class="form-control" disabled>
