...
if (isset($_GET['dpmtId'])) {
    $dpmtId = $_GET['dpmtId'];

    $result = mysql_query('SELECT dpmtId, department, dpmtStatus, modifiedBy, modifiedDate FROM department WHERE dpmtId = ' . $dpmtId . '');
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE department SET department = '$department', dpmtStatus = '$dpmtStatus', modifiedBy = '" . $_SESSION['Alogin'] . "', modifiedDate = '" . $timestamp . "' WHERE dpmtId = '$dpmtId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('Department details is edited successfully.');</script>";
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="department" type="textfield" value="<?php echo $row["department"]?>" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="dpmtStatus" class="form-control" required>
                                <option value="" selected="selected"><?php echo $row["dpmtStatus"]?></option></br>
