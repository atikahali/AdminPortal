...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tblusers SET FullName = '$FullName', EmployeeNo = '$EmployeeNo', Position = '$Position', Manager = '$Manager', Department = '$Department', Company = '$Company', Email = '$Email', status = '$status', modifiedBy = '".$_SESSION['Alogin']."', modifiedDate = '" . $timestamp . "' WHERE id = '$id'";
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="FullName" type="textfield" value="<?php echo $row["FullName"]?>" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="EmployeeNo" type="textfield" value="<?php echo $row["EmployeeNo"]?>" class="form-control" required>
                        </div>
                    </div>
