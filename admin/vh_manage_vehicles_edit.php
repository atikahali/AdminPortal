...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tblmastervehicles SET VehiclesType = '$VehiclesType', VehiclesBrand = '$VehiclesBrand', VehiclesPlateNo = '$VehiclesPlateNo', ModelYear = '$ModelYear', SeatingCapacity = '$SeatingCapacity', UpdationDate = '$timestamp', Status = '$Status' WHERE vehicleId = '$vehicleId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('The vehicle is edited successful.');</script>";
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="VehiclesBrand" type="textfield" value="<?php echo $row["VehiclesBrand"]?>" id="VehiclesBrand" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="VehiclesPlateNo" type="textfield" value="<?php echo $row["VehiclesPlateNo"]?>" id="VehiclesPlateNo" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="ModelYear" type="textfield" value="<?php echo $row["ModelYear"]?>" id="ModelYear" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="SeatingCapacity" type="textfield" value="<?php echo $row["SeatingCapacity"]?>" id="SeatingCapacity" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-2">
                            <button class="btn btn-primary" name="submit" type="submit" value="submit" style="width: 90px; height: 45px; font-size: 15px;">Edit</button>
                        </div>
                    </div>
                </form>
                <!--**************************************************************************************************************************-->
