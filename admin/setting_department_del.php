...
if (isset($_POST['submit'])) {
    ...
    $sql = "DELETE FROM department WHERE dpmtId = '$dpmtId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('Department details is deleted successfully.');</script>";
...
?>
<h2 class="page-title">Delete Department</h2>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="department" type="textfield" value="<?php echo $row["department"]?>" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="dpmtStatus" class="form-control" disabled>
