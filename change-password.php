...
if(isset($_POST['submit']))
{
    ...
    $sql ="SELECT password FROM tblusers WHERE EmployeeNo=:employeeNo and Password=:password";
    ...
    $results = $query -> fetchAll(PDO::FETCH_OBJ);
        ...
        if($query -> rowCount() > 0)
        {
            $con="update tblusers set Password=:newpassword where EmployeeNo=:employeeNo";
            $chngpwd1 = $dbh->prepare($con);
            $chngpwd1-> bindParam(':employeeNo', $employeeNo, PDO::PARAM_STR);
