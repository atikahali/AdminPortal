...
if (isset($_GET['bookingId'])) {
    ...
    $result = mysql_query('SELECT tblusers.FullName, tblusers.EmployeeNo, manager.manager, position.position, department.department, company.company, tbl_vbooking.VehiclesType,
                ...
                tbl_vbooking.Requisition, tbl_vbooking.Destination, tbl_vbooking.StatusM, tbl_vbooking.Remark, tbl_vbooking.DriverName, tbl_vbooking.VehiclesPlateNo, tbl_vbooking.VehiclesBrand, tbl_vbooking.Issuance, tbl_vbooking.FuelCard, 
