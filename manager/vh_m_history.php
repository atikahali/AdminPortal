    ...
    <div class="panel-body">
        <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            ...
            $sql = "SELECT tblusers.FullName, tblusers.EmployeeNo, manager.manager, position.position, department.department, company.company, tbl_vbooking.VehiclesType,
                ...
                tbl_vbooking.Requisition, tbl_vbooking.Destination, tbl_vbooking.Status, tbl_vbooking.StatusM, tbl_vbooking.Remark, tbl_vbooking.DriverName, tbl_vbooking.VehiclesPlateNo, tbl_vbooking.VehiclesBrand, tbl_vbooking.Issuance, tbl_vbooking.FuelCard, 
                ...
                AND (tbl_vbooking.StatusM = '1' OR tbl_vbooking.StatusM = '2') AND manager.ManagerNo = '".$_SESSION['Mlogin']."' ORDER BY tbl_vbooking.FromDate DESC";
            ...
            if($query->rowCount() > 0) {
                foreach($results as $result) {?>
                            <tr>
                                ...
                                <td><?php echo htmlentities($result->Pax);?><!-- <a href="#?=bid<?php echo htmlentities($result->bid);?>"data-toggle="modal" data-target="#myModal<?php echo ($result->bid)?>">Details</a>--></td>
                                <td><a href="?m=vh_m_request_prt&bookingId=<?php echo htmlentities($result->bid);?>">Details</a></td>
                                <!--Status display -->
                                <td><?php if($result->StatusM == '1')  { ?>
                                        <div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h4>Status: <?php if($result->StatusM == '1') { ?>
                                                    <div>
                                                        <p style="color:blue;"><b>APPROVED</b></p>
                                                    </div>
                                                <?php  } else { ?>
                                        ...
                                        <div class="modal-footer">
                                            <button onclick="location.href = '?m=vh_m_request_prt&bookingId=<?php echo ($result->bid)?>';">Print this page</td>
                                            </button>
                                        </div>
                                    </div>
                                </div>
