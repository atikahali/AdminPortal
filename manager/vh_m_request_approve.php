...
if (isset($_POST['approve'])) {
    ...
    $sql = "UPDATE tbl_vbooking SET modifiedDateM = current_timestamp, Status = '1', StatusM = '1' WHERE bookingId = '$bookingId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('The reservation is approved successful.');</script>";
        notifyEmailA($EmployeeNo, $Status, $bookingId);

        { redirect('?m=vh_m_history'); }
    } else {
...
if (isset($_POST['reject'])) {
    ...
    $sql = "UPDATE tbl_vbooking SET modifiedDateM = current_timestamp, Status = '2', StatusM = '2' WHERE bookingId = '$bookingId'";
    if ($rst = mysql_query($sql)) {
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Form field<button onclick="myFunction()" style="margin-left: 82%;">Print this page</button>
                <script>
                    function myFunction() {
                        window.print();
                    }
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div align="center">
                        </br><button class="btn btn-primary" name="approve" type="submit" value="approve" style="font-size: 15px;">Approve</button>
                        <button class="btn btn-primary" name="reject" type="submit" value="reject" style="font-size: 15px;">Reject</button>
                    </div>
                </form>
