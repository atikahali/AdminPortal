    ...
    <div class="panel-body">
        <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
            ...
            $sql = "SELECT tblusers.FullName, tblusers.EmployeeNo, manager.manager, position.position, department.department, company.company, tbl_vbooking.VehiclesType,
                ...
                AND tbl_vbooking.Status = '0' AND tblusers.Manager = '".$_SESSION['Mlogin']."' ORDER BY tbl_vbooking.FromDate DESC";
            ...
            if($query->rowCount() > 0) {
                foreach($results as $result) {?>
                    <tr>
                        ...
                        <td><a href="?m=vh_m_request_approve&no=<?php echo htmlentities($result->bid);?>">Process</a></td>
                    </tr>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <h4>From Date: <?php echo htmlentities($result->FromDate);?></h4>
                                    <h4>To Date: <?php echo htmlentities($result->ToDate);?></h4>
