...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tbl_vbooking SET modifiedDateM = current_timestamp, Status = '$Status', StatusM = '$StatusM' WHERE bookingId = '$bookingId'";
            ...
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="form-group" hidden>
                        ...
                        <div class="col-sm-4">
                            <input name="Status" type="textfield" value="2" class="form-control">
                            <input name="StatusM" type="textfield" value="2" class="form-control">
                        </div>
                    </div>
