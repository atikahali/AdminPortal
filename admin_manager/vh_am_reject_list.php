...
<h2 class="page-title">Rejected List</h2>
                    ...
                    if($result->Status != '0' && $result->Status != '1'){
                        if ($result->Status == '4'){?>
                            <tr>
                                ...
                                <td><a href="?am=vh_am_request_prt&bookingId=<?php echo htmlentities($result->bid);?>">Details</a></td>
                                <td><?php echo htmlentities($result->Remark);?></td>
                                <!--Status display -->
                                <td><?php if($result->StatusA == '4') { ?>
                                        <div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h4>Status: <?php  if($result->StatusA == '3')  { ?>
                                                    <div>
                                                        <p style="color:blue;"><b>ADMIN APPROVE</b></p>
                                                    </div>
                                                <?php } else { ?>
                                                    <div>
                                                        <p style="color:red;"><b>ADMIN REJECT</b></p>
