...
if (isset($_POST['approve'])) {
    ...
    $sql = "UPDATE tbl_vbooking SET modifiedDateM = current_timestamp, Status = '5' WHERE bookingId = '$bookingId'";
    if ($rst = mysql_query($sql)) {
        echo "<script>alert('The reservation is approved successful.');</script>";
        notifyEmailUA($EmployeeNo, $Status, $bookingId);
...
if (isset($_POST['reject'])) {
    ...
    $sql = "UPDATE tbl_vbooking SET modifiedDateM = current_timestamp, Status = '6' WHERE bookingId = '$bookingId'";
    if ($rst = mysql_query($sql)) {
